        ...
        <main>
            ...
            >
              ...
              <div className="relative z-10 flex flex-col h-full">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h2 className="text-lg sm:text-xl font-bold text-p4">Send a file</h2>
                </div>

                <p className="text-p4/70 mb-6 text-sm sm:text-base">Encrypt and upload files — generate a sharing code to give to others.</p>
            ...
            >
              ...
              <div className="relative z-10 flex flex-col h-full">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h2 className="text-lg sm:text-xl font-bold text-p4">Receive a file</h2>
                </div>

                <p className="text-p4/70 mb-6 text-sm sm:text-base">Enter a sharing code to fetch and decrypt files shared with you.</p>
          ...
          <div className="mt-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-sm text-p4/60 px-2">
            <div className="flex items-center gap-3">
              <div className="px-3 py-2 bg-s1/20 border border-s4/25 rounded-lg text-xs font-medium">End-to-end encrypted</div>
              <div className="px-3 py-2 bg-s1/20 border border-s4/25 rounded-lg text-xs font-medium">Expires in 1h</div>
              <div className="px-3 py-2 bg-s1/20 border border-s4/25 rounded-lg text-xs font-medium">Zero-knowledge</div>
            </div>
